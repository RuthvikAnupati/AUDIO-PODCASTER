...
const YourPodcasts = () => {
    ...
    useEffect(() => {
        const fetch = async() => {
            const res = await axios.get(`${BACKEND_URL}/api/v1/get-user-podcasts`, {withCredentials:true});
    ...
    return (
        <div className='px-4 lg:px-12 my-4'>
            <div className='flex items-center justify-between gap-4'>
                ...
                <Link to="/add-podcasts" className='px-4 py-2 bg-zinc-800 text-white rounded font-semibold'>Add Podcast</Link>
            </div>
